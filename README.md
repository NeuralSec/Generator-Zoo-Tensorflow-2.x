...
**The aim of this repo is to provide a collection of pretrained generators from various GANs for Tensorflow 2.x / Keras.** Welcome to contribute by including pretrained tf2.x GANs you discovered to this repo. 
